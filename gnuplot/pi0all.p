...
set title 'Data pi 0'
#plot graph
plot 'raspberrypi-0.csv' using 2:4 w l t "Amp", 'raspberrypi-0.csv' using 2:5 w l t "Voltage", 'raspberrypi-0.csv' u 2:6 w l t "Watts", 'raspberrypi-0.csv' u 2:7 w l t "Celcius"
