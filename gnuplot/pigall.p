...
set title 'Data pi g'
#plot graph
plot 'raspberrypi-g.csv' using 2:4 w l t "Amp", 'raspberrypi-g.csv' using 2:5 w l t "Voltage", 'raspberrypi-g.csv' u 2:6 w l t "Watts", 'raspberrypi-g.csv' u 2:7 w l t "Celcius"
